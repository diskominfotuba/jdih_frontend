        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
            ...
            <main className="flex-grow pt-28 pb-16 px-4 sm:px-6 lg:px-8">
                <div className="max-w-6xl mx-auto">
                    {/* Header Section */}
                    <div className="mb-8">
                        <h1 className="text-3xl font-bold text-gray-900 mb-2">Detail Produk Hukum</h1>
                        <p className="text-gray-600">Informasi lengkap mengenai dokumen hukum</p>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="bg-gray-50 px-6 py-4 border-t border-gray-100 flex justify-end gap-3">
                           <button
                            ...
                            <button className="px-4 py-2 bg-primary text-white rounded-lg hover:bg-blue-800 font-medium transition-colors shadow-sm flex items-center gap-2 cursor-pointer">
