            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-xs text-gray-400 font-medium">Kabupaten Tulang Bawang</span>
                            </div>
                        </div>
                        <p className="text-gray-400 text-sm leading-relaxed max-w-md">
                            Jaringan Dokumentasi dan Informasi Hukum (JDIH) Kabupaten Tulang Bawang adalah wadah pendayagunaan bersama atas dokumen hukum secara tertib, terpadu, dan berkesinambungan.
                        </p>
                    </div>

                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-secondary">Tautan Cepat</h3>
                        <ul className="space-y-2">
                            <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Beranda</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Produk Hukum</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Berita</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Profil</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white text-sm transition-colors">Kontak</a></li>
                        </ul>
                    </div>

                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-secondary">Kontak Kami</h3>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-gray-500 text-sm text-center md:text-left">
                        &copy; {new Date().getFullYear()} JDIH Kabupaten Tulang Bawang. All rights reserved.
                    </p>
